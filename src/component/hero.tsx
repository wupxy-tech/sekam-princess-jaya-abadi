...
const Hero = forwardRef<HTMLDivElement, HeroProps>(({ dict, lang, images }, ref) => {
    const img = {
    ...
    return (
        <section ref={ref} className="relative w-full bg-[#FFFFF2] text-[#1D252A]">
            ...
            <div className="mx-auto py-6 md:py-8 lg:py-10">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-0 relative border-y border-[#BEBDB2]">
                    {/* Kolom kiri */}
                    <div className="md:col-span-5 flex flex-col divide-y divide-[#BEBDB2]">
                        {/* Card teks + gambar kecil */}
                        <div className="p-5 flex gap-4">
                            <div className="shrink-0 w-24 h-24 sm:w-28 sm:h-28 bg-white overflow-hidden">
                                <img src={img.small} alt="Small promo" className="w-full h-full object-cover" />
                            </div>
                            <div className="min-w-0">
                                ...
                                <Link
                                    href={ctaLink}
                                    className="group inline-flex items-center gap-2 mt-3 text-sm font-medium border-b border-[#1D252A] hover:text-[#B7A458] hover:border-[#B7A458]"
                                >
                                    {dict.cta}
                                    <span
                    ...
                    {/* Kolom kanan */}
                    <div className="md:col-span-7 relative border-l border-[#BEBDB2]">
                        <img
                            src={img.main}
                            alt="Hero main"
